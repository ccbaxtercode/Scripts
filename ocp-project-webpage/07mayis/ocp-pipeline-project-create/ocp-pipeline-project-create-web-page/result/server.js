...
function triggerPipelineRun(projectName, assignmentType, userOrGroupName, userOrGroupNames, quota, role, pipelinerunuser) {
  ...
  const pipelineRun = {
    ...
    spec: {
      pipelineRef: { name: 'provision-openshift-project' },
      params: [
