...
Uses the release name if it doesn't contain the chart name.
*/}}
{{- define "k3s.fullname" -}}
...
OpenShift-compatible: no special chars in values, max 63 chars
*/}}
{{- define "k3s.labels" -}}
...
Used to identify master VMs and pods.
*/}}
...
Used to identify worker VMs and pods.
*/}}
...
{{/*
Service DNS name for K3s API.
Used internally by VMs to communicate with K3s control plane.
*/}}
{{- define "k3s.serviceDNS" -}}
{{- printf "%s-k3s-api.%s.svc.cluster.local" .Release.Name .Release.Namespace -}}
{{- end }}
